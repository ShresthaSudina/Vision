...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"D:\face_recognition_system\Image\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"Image\bg2.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Face Recognition Pannel",font=("verdana",30),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1530,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"Image\f_det.jpg")
        ...
        std_b1_1 = Button(bg_img,command=self.face_recog,text="Face Detector",cursor="hand2",font=("tahoma",15),bg="white",fg="navyblue")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                cursor.execute("select Course from student where ID="+str(id))
                r=cursor.fetchone()
                r="+".join(r)
                ...
                if confidence > 77:
                    ...
                    cv2.putText(img,f"Course:{r}",(x,y-30),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
